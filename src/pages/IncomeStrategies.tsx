          ...
          <div className="text-center space-y-6 mb-12">
            ...
            <div className="grid md:grid-cols-4 gap-4 max-w-2xl mx-auto">
              ...
              <div className="flex items-center gap-2 justify-center">
                ...
                <span className="text-sm">22,100+ enrolled</span>
              </div>
              <div className="flex items-center gap-2 justify-center">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-muted-foreground max-w-md mx-auto">
                    Our most advanced course is being crafted to show you
                    exactly how to build a $10K+ monthly income through digital
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid md:grid-cols-2 gap-3 text-left max-w-2xl mx-auto">
                    ...
                    <div className="flex items-center gap-2">
                      <div className="h-2 w-2 rounded-full bg-primary"></div>
                      <span className="text-sm">Automation & outsourcing</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <div className="h-2 w-2 rounded-full bg-primary"></div>
                      <span className="text-sm">Agency building</span>
                    </div>
                  </div>
                </div>
